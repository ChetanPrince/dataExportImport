...
// // go through table data and find each category value and match it with the selected category
// // then store that in  a separate object with key value pair or in an array
// //  loop through array to find each object's expense
// //  add function on that array
// //  and display it on page

// const filterValue = document.getElementById("category").value;
